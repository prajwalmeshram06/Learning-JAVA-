        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    book.setBookDetails(title, bookCode, price, category);
                    books.add(book);
                ...
                case 4:
                    ...
                    System.out.print("Select Book to see its Librarian: ");

                    int selectedBook = sc.nextInt();
                    sc.nextLine();

                    if (selectedBook < 1 || selectedBook > books.size()) {

                        System.out.println("Error: Invalid Book choice.");
                        break;
                    }

                    Librarian assignedLibrarian = books.get(selectedBook - 1).getLibrarian();
